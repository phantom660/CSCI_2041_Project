...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LPAREN
    | IDENT of (
# 4 "Project/lib/parser.mly"
       (string)
# 16 "Project/lib/parser.ml"
  )
    | EOF
...
# 1 "Project/lib/parser.mly"
  
    open Ast

# 42 "Project/lib/parser.ml"

let rec _menhir_goto_expression : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expression) -> 'ttv_return =
...
# 15 "Project/lib/parser.mly"
                                   ( e )
# 66 "Project/lib/parser.ml"
             in
    ...
    | MenhirState7 | MenhirState5 | MenhirState3 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        (match _tok with
        ...
        | EOF | RPAREN ->
            ...
            let _v : (Ast.expression) = 
# 17 "Project/lib/parser.mly"
                                   ( Application (e1, e2))
# 88 "Project/lib/parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v)
    | MenhirState0 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 12 "Project/lib/parser.mly"
                       ( [e] )
# 104 "Project/lib/parser.ml"
             in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
...
# 4 "Project/lib/parser.mly"
       (string)
# 168 "Project/lib/parser.ml"
    )) = _v in
    let _v : (Ast.expression) = 
# 16 "Project/lib/parser.mly"
             ( Identifier nm )
# 173 "Project/lib/parser.ml"
     in
    _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
